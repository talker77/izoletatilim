...
return [
    ...
    */
    ...
    'between' => [
        'numeric' => ':attribute :min - :max arasinda olmalidir.',
    ...
    */
    ...
    'attributes' => [
        ...
        'email' => 'Email',
        'password' => "Şifre",
        'slug' => "Slug Alanı(link)",
        'price' => "Fiyat",
        'desc' => "Açıklama",
        'qty' => "Adet",
        'imageGallery' => "Fotoğraf Galerisi",
    ...
    'credit_card' => [
        'card_length_invalid' => 'Kredi Kartı Kart numarası eksik',
        'card_expiration_year_invalid' => 'Kredi Kartı son kullanma yılı hatalı',
        'card_expiration_month_invalid' => 'Kredi Kartı son kullanma ay hatalı',
        'card_invalid' => 'Kredi Kartı bilgileri hatalı',
        'card_cvc_invalid' => 'Cvv kodu hatalı',
    ],
