    ...
    <div class="page-title-container">
        <div class="container">
            ...
            <ul class="breadcrumbs pull-right">
                ...
                <li class="active">Hesabım - Kullanıcı</li>
            </ul>
        </div>
    </div>
                            ...
                            <div class="row block">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-sm-6 col-md-12">
                                        <a href="{{ route('user.reservations.index',['status' => \App\Models\Reservation::STATUS_IPTAL]) }}">
                                            <div class="fact red">
                                                <div class="numbers counters-box">
                                                    <dl>
                                                        <dt>
                                                            {{ loggedPanelUser()->reservations()->where(['status' => \App\Models\Reservation::STATUS_IPTAL])->count() }}
                                                        </dt>
                                                        <dd>İptal Edilen</dd>
                                                    </dl>
                                                    <i class="icon soap-icon-close"></i>
                                                </div>
                                    ...
                                    <div class="col-sm-6 col-md-12">
                                        <a href="{{ route('user.reservations.index',['status' => \App\Models\Reservation::STATUS_ONAY_BEKLIYOR]) }}">
                                            <div class="fact yellow">
                                                <div class="numbers counters-box">
                                                    <dl>
                                                        <dt>
                                                            {{ loggedPanelUser()->reservations()->where(['status' => \App\Models\Reservation::STATUS_ONAY_BEKLIYOR])->count() }}
                                                        </dt>
                                                        <dd>Onay Bekleyen</dd>
                                                    </dl>
                                                    <i class="icon soap-icon-clock"></i>
                                                </div>
                                                <div class="description">
                                                    <i class="icon soap-icon-longarrow-right"></i>
                                                    <span>Tümünü Göster</span>
                                    ...
                                    <div class="col-sm-6 col-md-12">
                                        <a href="{{ route('user.reservations.index',['status' => \App\Models\Reservation::STATUS_ONAYLANDI]) }}">
                                            <div class="fact green">
                                                <div class="numbers counters-box">
                                                    <dl>
                                                        <dt>
                                                            {{ loggedPanelUser()->reservations()->where(['status' => \App\Models\Reservation::STATUS_ONAYLANDI])->count() }}
                                                        </dt>
                                                        <dd>Onaylanan</dd>
                                                    </dl>
                                                    <i class="icon soap-icon-insurance"></i>
                                                </div>
                                                <div class="description">
                                                    <i class="icon soap-icon-longarrow-right"></i>
                                                    <span>Tümünü Göster</span>
                                ...
                                @foreach($reservations as $reservation)
                                    <div class="col-sm-6 col-lg-4">
                                        <article class="box box-border">
                                            <figure>
                                                <span>
                                                    <img class="img-service-thumb" alt="" src="{{ imageUrl('public/services/thumb',$reservation->service->image) }}"></span>
                                            </figure>
                                            <div class="details">
                                                <span class="price"><small>Toplam</small>{{ $reservation->total_price }} ₺</span>
                                                <h4 class="box-title">
                                                    <a href="{{ route('user.reservations.show',['reservation' => $reservation->id]) }}">
                                                        {{ str_limit($reservation->service->title,13) }}
                                                        <small>{{ $reservation->service->type->title }}</small>
                                                    </a>
                                                </h4>
                                                <div class="time">
                                                    <div class="take-off">
                                                ...
                                                <div class="action">
                                                    <div class="row">
                                                        ...
                                                        @if(loggedPanelUser()->isCustomer() and in_array($reservation->status,[\App\Models\Reservation::STATUS_ONAY_BEKLIYOR,\App\Models\Reservation::STATUS_EMAIL_ONAY_BEKLIYOR]))
                                                            <div class="col-md-4">
                                                                <form method="POST"
                                                                      action="{{ route('user.reservations.cancel',['reservation' => $reservation->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
