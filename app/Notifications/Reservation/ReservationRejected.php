...
class ReservationRejected extends Notification
{
    ...
    public function toMail(User $user)
    {
        ...
        return (new MailMessage)
            ...
            ->line("{$service->title} için {$reservation->start_date}-{$reservation->end_date} tarihleri arasında talep etmiş olduğunuz rezervasyon ilan sahibi tarafından iptal edildi.")
